...
<template>
  <div class="initPanel">
    ...
    <el-table class="initTable" :data="state.requestResult" v-loading="state.loading" element-loading-text="加载中" border>
      ...
      <el-table-column align="center" prop="channel_val" label="渠道号" />
      <el-table-column align="center" prop="valid_invite_count" label="有效发起人数" />
      <el-table-column align="center" prop="invited_user_count" label="受邀注册人数" />
      <el-table-column align="center" prop="fission_rate" label="裂变率" />
      <el-table-column align="center" prop="invited_active_count" label="受邀活跃人数" />
      <el-table-column align="center" prop="invited_active_rate" label="受邀活跃率" />
      <el-table-column align="center" prop="total_invite_award" label="发起邀请人总奖励" />
      <el-table-column align="center" prop="total_invited_award" label="受邀请人总奖励" />
    </el-table>
