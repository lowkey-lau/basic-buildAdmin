...
<template>
  <div class="initPanel">
    ...
    <el-table class="initTable" :data="state.requestResult" v-loading="state.loading" element-loading-text="加载中" border>
      ...
      <el-table-column min-width="180" align="center" prop="offer_name" label="Offer名称" />
      ...
      <el-table-column min-width="140" align="center" prop="valid_offer_record" label="有效接单人数" />
      <el-table-column min-width="100" align="center" prop="finish_count" label="完单人数" />
      <el-table-column min-width="100" align="center" prop="finish_rate" label="完单率" />
      <el-table-column min-width="100" align="center" prop="install_count" label="安装人数" />
      <el-table-column min-width="100" align="center" prop="activate_count" label="激活人数" />
      <el-table-column min-width="120" align="center" label="任务完成总数">
        <template #default="{ row }">
          <el-popover effect="light" trigger="hover" placement="top" width="auto" :disabled="row.subtaskLength == 0">
            <template #default>
      ...
      <el-table-column min-width="140" align="center" prop="aver_completion" label="人均完成任务数" show-overflow-tooltip />
      <el-table-column min-width="100" align="center" prop="total_award" label="生涯总奖励" />
    </el-table>
...
const searchData = async () => {
  ...
  try {
    ...
    state.requestResult.forEach((item) => {
      item.subtaskLength = item.subtask_completion.length;
    });
...
const getRequestData = (flag = false) => {
  return new Promise((resolve, reject) => {
    $api.orderManagement.orderDataByCareer
      .GetList({
